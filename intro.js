...
function IntroJs(obj) {
  ...
  this._options = {
    ...
    /* additional option to set position progress*/
...
function _showElement(targetElement) {
  ...
  if (oldHelperLayer !== null) {
    var oldHelperNumberLayer = oldReferenceLayer.querySelector('.introjs-helperNumberLayer'),
        oldProgressStep = oldReferenceLayer.querySelector('.introjs-progress-step'), //flowaccount_custom
    ...
    self._lastShowElementTimer = window.setTimeout(function() {
      ...
      // customise to show step change
      if (oldProgressStep !== null) {
        oldProgressStep.innerHTML = targetElement.step+"/"+self._options.steps.length;
      }
    ...
    // customise to show step
    var progressStep = document.createElement('div');
    progressStep.className = 'introjs-progress-step';
    progressStep.innerHTML = targetElement.step+"/"+this._options.steps.length;
    progressLayer.appendChild(progressStep);
